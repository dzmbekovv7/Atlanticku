	...
	if (isArticleLoading || isArticlesLoading) {
		return (
			<div className='relative min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 overflow-hidden'>
				...
				<Container>
			<div className="relative z-10 py-20 flex items-center justify-center min-h-screen bg-gradient-to-br from-[#0f0f1b] via-[#101426] to-[#0a0c17] overflow-hidden">
  {/* Анимированные линии и круги фона */}
  <div className="absolute inset-0 pointer-events-none z-0">
    <div className="absolute top-1/4 left-1/3 w-1 h-40 bg-gradient-to-b from-indigo-500 to-transparent opacity-30 animate-pulse"></div>
    <div className="absolute bottom-1/3 right-1/4 w-40 h-1 bg-gradient-to-r from-fuchsia-500 to-transparent opacity-25 animate-pulse"></div>
    <div className="absolute top-[60%] left-[10%] w-16 h-16 border-2 border-violet-500 rounded-full opacity-20 animate-spin-slow"></div>
  </div>

  <div className="text-center space-y-8 relative z-10">
    {/* Новый лоадер — гексагон в 3D */}
    <div className="relative w-32 h-32 mx-auto">
      <div
        className="absolute inset-0 bg-gradient-to-br from-violet-600 to-purple-700 transform rotate-45 animate-spin"
        style={{
          clipPath:
      ...
      ></div>
      <div className="absolute inset-4 bg-[#0e0f19] transform rotate-45 flex items-center justify-center border border-violet-500/50 shadow-inner rounded-md">
        <div className="text-2xl font-black text-violet-400 tracking-wide animate-pulse">Atlanticku</div>
      </div>
    </div>

    {/* Текст с техно стилем */}
    <div className="space-y-2">
      <h2 className="text-3xl font-extrabold text-white tracking-tight">
        Conquering <span className="text-violet-400">Content Heights</span>
      </h2>
      <p className="text-gray-400 text-lg">Loading exclusive materials...</p>
    </div>
  </div>
</div>
